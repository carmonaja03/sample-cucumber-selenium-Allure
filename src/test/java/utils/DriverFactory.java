...
//import utils.SauceLabsDriverManager;
import org.openqa.selenium.WebDriver;
import org.openqa.selenium.support.ui.WebDriverWait;
import automation.library.selenium.exec.driver.managers.AppiumDriverManager;
import automation.library.selenium.exec.driver.managers.BitBarDriverManager;
import automation.library.selenium.exec.driver.managers.BrowserStackDriverManager;
import automation.library.selenium.exec.driver.managers.ChromeDriverManager;
import automation.library.selenium.exec.driver.managers.EdgeDriverManager;
import automation.library.selenium.exec.driver.managers.FirefoxDriverManager;
import automation.library.selenium.exec.driver.managers.GridDriverManager;
import automation.library.selenium.exec.driver.managers.HTMLUnitDriverManager;
import automation.library.selenium.exec.driver.managers.IEDriverManager;
import automation.library.selenium.exec.driver.managers.PhantomJSDriverManager;
import automation.library.selenium.exec.driver.managers.SafariDriverManager;
...
public class DriverFactory {
    ...
    public DriverManager setDM() {
        automation.library.selenium.exec.driver.factory.DriverFactory.ServerType serverType = automation.library.selenium.exec.driver.factory.DriverFactory.ServerType.valueOf(DriverContext.getInstance().getTechStack().get("seleniumServer"));
